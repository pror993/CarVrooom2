...
import { HiCog, HiLogout, HiUser, HiClipboardList, HiCheckCircle } from 'react-icons/hi'
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="mb-8">
                    <h2 className="text-3xl font-bold mb-2">Technician Dashboard</h2>
                    <p className="text-gray-400">Your jobs and tasks, {user?.profile?.name || user?.email}!</p>
                </div>
                    ...
                    <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                        <div className="flex items-center gap-4">
                            <div className="p-3 bg-blue-900/20 rounded-lg">
                                <HiClipboardList className="text-3xl text-blue-400" />
                            </div>
                            <div>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span className="font-medium">{user?.profile?.certificationLevel || 'Not set'}</span>
                        </div>
                        <div className="flex justify-between">
